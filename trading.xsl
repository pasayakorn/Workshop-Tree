...
<table width="100%" border="1" style="border-collapse: collapse">
    <tr>
        ...
        <td width="15%" bgcolor="#282c36"><font face="LINE seed sans TH" size="7" color="white">ชื่อลูกค้า</font></td> 
        <td width="20%" bgcolor="#282c36"><font face="LINE seed sans TH" size="7" color="white">วันที่</font></td> 
...
<xsl:for-each select="trading/product">
    <tr>
        ...
        <td><font face="LINE seed sans TH" size="5"><xsl:value-of select="date"/></font></td> 
